var e=globalThis,o={},t={},a=e.parcelRequire0688;null==a&&((a=function(e){if(e in o)return o[e].exports;if(e in t){var a=t[e];delete t[e];var s={id:e,exports:{}};return o[e]=s,a.call(s.exports,s,s.exports),s.exports}var i=Error("Cannot find module '"+e+"'");throw i.code="MODULE_NOT_FOUND",i}).register=function(e,o){t[e]=o},e.parcelRequire0688=a);var s=a.register;s("ifJdc",function(e,o){Object.defineProperty(e.exports,"register",{get:()=>t,set:e=>t=e,enumerable:!0,configurable:!0});var t,a=new Map;t=function(e,o){for(var t=0;t<o.length-1;t+=2)a.set(o[t],{baseUrl:e,path:o[t+1]})}}),s("jaNa7",function(e,o){e.exports=new URL("amazon.702e28b6.png",import.meta.url).toString()}),s("4g0bO",function(e,o){e.exports=new URL("apple-books.75f7682c.png",import.meta.url).toString()}),s("cGAW0",function(e,o){e.exports=new URL("placeholder.18062ded.jpg",import.meta.url).toString()}),a("ifJdc").register(new URL("",import.meta.url).toString(),JSON.parse('["lbZNw","index.caf74401.js","9zlPt","placeholder.18062ded.jpg","i6YUf","amazon.702e28b6.png","jHlqi","apple-books.75f7682c.png","5TVzx","shopping-list.64f27a34.js","8BfbS","shopping-list.runtime.3120d981.js"]')),a("dyvSB");const i=document.querySelector('[data-content="top-books"]'),l=document.querySelector('[data-content="category"]'),r=e=>{"topBooks"===e?(i.classList.add("visible"),i.classList.remove("right","hidden"),l.classList.remove("visible"),l.classList.add("left","hidden")):"category"===e&&(l.classList.add("visible"),l.classList.remove("left","hidden"),i.classList.remove("visible"),i.classList.add("right","hidden"))};var n=a("dyvSB");(async()=>{let e=document.querySelector(".category-list"),o=await (0,n.fetchBooks)("category-list");o.sort((e,o)=>e.list_name.localeCompare(o.list_name));let t=`<div>
        ...
        </div>`).join(""),e.insertAdjacentHTML("beforeend",t)})();var n=(a("dyvSB"),a("dyvSB"));const c=document.querySelector(".modal-pop-up-content"),d=e=>{let o=document.querySelector(".backdrop-pop-up");e?o.classList.remove("is-hidden"):o.classList.add("is-hidden")},b=document.querySelector(".backdrop-pop-up");b.addEventListener("click",function(e){e.target===b&&d(!1)}),document.querySelector(".close-modal-button").addEventListener("click",function(){c.innerHTML="",d(!1)}),document.addEventListener("keydown",function(e){"Escape"===e.key&&d(!1)});var u=a("lthku");const v=()=>{document.querySelectorAll(".modal-pop-up-btn").forEach(function(e){let o=e.getAttribute("data-book-id");(0,u.checkIfBookInLocalStorage)(o)?(e.textContent="Remove from the shopping list",(0,u.toggleCongratulatoryMessage)(!0)):(0,u.toggleCongratulatoryMessage)(!1),e.addEventListener("click",function(){(0,u.checkIfBookInLocalStorage)(o)?((0,u.removeFromLocalStorage)(o),e.textContent="Add to shopping list",(0,u.toggleCongratulatoryMessage)(!1)):((0,u.addToLocalStorage)(o),e.textContent="Remove from the shopping list",(0,u.toggleCongratulatoryMessage)(!0))})})},m=async e=>{d(!0);let{_id:o,title:t,author:s,book_image:i,description:l,buy_links:r}=await (0,n.fetchBooks)(`${e}`),b=[{name:"Amazon",imageUrl:new URL(a("jaNa7")).href,buyUrl:""},{name:"Apple Books",imageUrl:new URL(a("4g0bO")).href,buyUrl:""}],u=r.filter(e=>b.some(o=>o.name===e.name));b.forEach(e=>{let o=u.find(o=>o.name===e.name);e.buyUrl=o?o.url:""});let m=b.map(e=>`<a href="${e.buyUrl}" target="_blank"><img src="${e.imageUrl}" alt="${e.name}"></a>`).join(""),g=new URL(a("cGAW0")).href,_=`
    <div class="modal">
      <div class="modal__info">
        <div class="modal__cover">
        <img class="lazyload" src="${g}" data-src="${i}" alt="${t}">
        </div>
  ...
  `;c.innerHTML=_,v()},g=async()=>{r("topBooks");let e=await (0,n.fetchBooks)("top-books"),o=new URL(a("cGAW0")).href,t=e.map(e=>{let t=e.books.map(({title:e,author:t,book_image:a,_id:s})=>`
  ...
  `;l.innerHTML=i,document.querySelectorAll(".books__book").forEach(e=>{e.addEventListener("click",()=>{let o=e.dataset.bookId;console.log("Displaying book with ID:",o),m(o)})})},p=()=>{l?l.scrollIntoView({behavior:"smooth",block:"start"}):console.error("Books not found.")};i.addEventListener("click",e=>{let o=e.target.closest('button[name="See more"]');if(o){let e=o.getAttribute("data-category");_(e),document.querySelectorAll(".category-list button[name]").forEach(o=>{o.classList.remove("active"),o.getAttribute("name")===e&&(o.classList.add("active"),o.scrollIntoView({behavior:"smooth",block:"center"}))}),p()}}),document.querySelector(".category-list").addEventListener("click",e=>{let o=e.target.closest("button[name]");if(o){document.querySelectorAll("button[name]").forEach(e=>e.classList.remove("active")),o.classList.add("active");let e=o.getAttribute("name");"All categories"===e?g():(_(e),p())}});
//# sourceMappingURL=index.caf74401.js.map
